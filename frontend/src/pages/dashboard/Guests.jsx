          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            <div className="relative w-full sm:w-auto flex-1">
              <input 
                ...
                className="pl-10 pr-4 py-2.5 bg-[var(--color-surface-container-lowest)] rounded-md outline-none focus:ring-2 focus:ring-[var(--color-secondary)]/30 text-sm w-full sm:w-64 ambient-shadow"
              />
            ...
            <div className="flex items-center gap-2 justify-end w-full sm:w-auto">
              ...
              >
                ...
                <span className="hidden lg:inline">Plantilla (.xlsx)</span>
              </button>
              ...
              <button 
                onClick={() => openDrawer()}
                className="bg-[var(--color-primary)] text-white px-4 sm:px-5 py-2.5 rounded-md text-xs sm:text-sm font-semibold hover:bg-[#1a1a1a] transition-colors ambient-shadow flex items-center gap-2 ml-1"
              >
