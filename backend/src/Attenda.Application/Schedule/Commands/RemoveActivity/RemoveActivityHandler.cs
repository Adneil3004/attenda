...
public class RemoveActivityHandler : IRequestHandler<RemoveActivityCommand, Unit>
{
    private readonly IEventRepository _eventRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RemoveActivityHandler(IEventRepository eventRepository, IUnitOfWork unitOfWork)
    {
    ...
    public async Task<Unit> Handle(RemoveActivityCommand request, CancellationToken cancellationToken)
    {
        ...
        @event.RemoveActivity(request.ActivityId);
