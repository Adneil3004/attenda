# 🦾 Attenda Agent Orchestration Hub (Engram Pattern)

Este es el centro de mando para la orquestación de agentes en el proyecto Attenda. Sigue el patrón desarrollado por **Gentleman Programming** en el proyecto **Engram**.

## 🎯 Meta del Proyecto
Construir una plataforma de gestión de eventos "Concierge-level" con una arquitectura limpia (.NET Backend + React Frontend) y una experiencia de usuario premium.
